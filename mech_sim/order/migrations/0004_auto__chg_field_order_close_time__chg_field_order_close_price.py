...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'order_order', 'close_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Order.close_price'
        db.alter_column(u'order_order', 'close_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.close_time'
        db.alter_column(u'order_order', 'close_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 11, 28, 0, 0)))

        # Changing field 'Order.close_price'
        db.alter_column(u'order_order', 'close_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))
