...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.per_size_gross_profit'
        db.add_column(u'order_order', 'per_size_gross_profit',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.per_size_gross_profit'
        db.delete_column(u'order_order', 'per_size_gross_profit')
