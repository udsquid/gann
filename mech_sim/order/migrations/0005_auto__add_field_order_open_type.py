...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.open_type'
        db.add_column(u'order_order', 'open_type',
                      self.gf('django.db.models.fields.CharField')(default=0L, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.open_type'
        db.delete_column(u'order_order', 'open_type')
